...
*/
public class DDXQScanOldActivity extends BaseActivity {
    ...
    private void getOrderDetail(){
        RequestParams params = AsynClient.getRequestParams();
        AsynClient.get(MyHttpConfing.getBaseUrl()+MyHttpConfing.getEntityDetail.replaceAll("menuId",MyHttpConfing.zjddMenuId)+orderCode, this, params, new GsonHttpResponseHandler() {
            @Override
            protected Object parseResponse(String rawJsonData) throws Throwable {
                return null;
            }
    ...
    *设置字段键名称
    ...
    private void  initJieLunSpinner(){
        jieLunAdapter = new SimpleAdapter(DDXQScanOldActivity.this);
        ...
        AsynClient.post(MyHttpConfing.getBaseUrl()+MyHttpConfing.doEntityDetailNormal.replaceAll("menuId",MyHttpConfing.zjbgMenuId), this, params, new GsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, String rawJsonResponse, Object response) {
                ...
                String status=jo.getString("status");
                    if("suc".equals(status)){
                        MyToast("质检完毕，"+jielun);
                        Intent intent = new Intent(DDXQScanOldActivity.this, MainActivity.class);
                        startActivity(intent);
                        AllActivitiesHolder.removeAct(DDXQScanOldActivity.this);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void MyToast(String s) {
        Toast.makeText(DDXQScanOldActivity.this, s, Toast.LENGTH_SHORT).show();
    }
}
