...
public class DDRKCPHOldActivity extends BaseActivity {
        ...
        try {
            mTitle.setEvents(new TitleBar.AddClickEvents() {
                ...
                public void clickLeftButton() {
                    AllActivitiesHolder.removeAct(DDRKCPHOldActivity.this);
                }
    ...
    private void initDDRKCriteriaId(){
        ...
        AsynClient.get(MyHttpConfing.getBaseUrl()+MyHttpConfing.getEntityListTmpl.replaceAll("menuId",MyHttpConfing.ddrkMenuId), this, params, new GsonHttpResponseHandler() {
            @Override
    ...
    private void initGroupsFieldsId(){
        RequestParams params = AsynClient.getRequestParams();
        AsynClient.get(MyHttpConfing.getBaseUrl()+MyHttpConfing.doDtmplNormal.replaceAll("menuId",MyHttpConfing.ddrkMenuId), this, params, new GsonHttpResponseHandler() {
            @Override
            protected Object parseResponse(String rawJsonData) throws Throwable {
                return null;
            }
    ...
    private void getOrderDetail(){
        RequestParams params = AsynClient.getRequestParams();
        AsynClient.get(MyHttpConfing.getBaseUrl()+MyHttpConfing.getEntityDetail.replaceAll("menuId",MyHttpConfing.ddrkMenuId)+ddrkCode, this, params, new GsonHttpResponseHandler() {
            @Override
            protected Object parseResponse(String rawJsonData) throws Throwable {
                return null;
            }
    ...
    private void  initLLLXSpinner(){
        lxlxAdapter = new SimpleAdapter(DDRKCPHOldActivity.this);
    ...
    private void  initZXZTSpinner(){
        zxztAdapter = new SimpleAdapter(DDRKCPHOldActivity.this);
    ...
    private void  initRKZTSpinner(){
        rkztAdapter =new SimpleAdapter(DDRKCPHOldActivity.this);
    ...
    private void saveOrderRK() throws JSONException {
        ...
        */
        AsynClient.post(MyHttpConfing.getBaseUrl()+MyHttpConfing.doEntityDetailNormal.replaceAll("menuId",MyHttpConfing.ddrkMenuId), this, params, new GsonHttpResponseHandler() {
            @Override
            protected Object parseResponse(String rawJsonData) throws Throwable {
                return null;
            }
            ...
            public void onSuccess(int statusCode, String rawJsonResponse, Object response) {
                ...
                try {
                    ...
                    if("suc".equals(status)){
                        MyToast("审核完毕");
                        Intent intent = new Intent(DDRKCPHOldActivity.this, MainActivity.class);
    ...
    public void MyToast(String s) {
        Toast.makeText(DDRKCPHOldActivity.this, s, Toast.LENGTH_SHORT).show();
    }
}
